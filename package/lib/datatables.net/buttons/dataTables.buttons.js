...
(function (f) {
    ...
    f.extend(u.prototype, {
                ...
                if (l)
                    if (Array.isArray(l)) this._expandButton(a, l, c, d);
                        ...
                        k &&
                            ...
                            k.conf.buttons && ((k.collection = f("<" + this.c.dom.collection.tag + "/>")), (k.conf._collection = k.collection), this._expandButton(k.buttons, k.conf.buttons, !0, d)),
        ...
        _popover: function (a, b, c) {
            ...
            if ("absolute" === g && (c.hasClass(e.rightAlignClassName) || c.hasClass(e.leftAlignClassName) || "dt-container" === e.align)) {
                var l = h.position();
                ...
                B = w + B;
                w = 0;
                c.hasClass(e.rightAlignClassName) ? ((w = B - x), l > g + w && ((g = l - (g + w)), (d -= x + w), (w = g > d ? w + d : w + g))) : ((w = l - g), d < x + w && ((g = l - (g + w)), (d -= x + w), (w = g > d ? w + d : w + g)));
                ...
                "absolute" === g
                    ? ((l = h.position()),
                      ...
                      c.css("left", c.position().left + w))
                    : ((g = c.height() / 2), g > f(A).height() / 2 && (g = f(A).height() / 2), c.css("marginTop", -1 * g));
    ...
    u.buttonSelector = function (a, b) {
        for (
            var c = [],
                d = function (g, l, k) {
                    for (var n, p, r = 0, v = l.length; r < v; r++) if ((n = l[r])) (p = k !== t ? k + r : r + ""), g.push({ node: n.node, name: n.conf.name, idx: p }), n.buttons && d(g, n.buttons, p + "-");
                },
                e = function (g, l) {
                    var k,
                        n = [];
                    ...
                    if (Array.isArray(g) || g instanceof f) for (p = 0, k = g.length; p < k; p++) e(g[p], l);
                    else if (null === g || g === t || "*" === g) for (p = 0, k = n.length; p < k; p++) c.push({ inst: l, node: n[p].node });
                    else if ("number" === typeof g) c.push({ inst: l, node: l.s.buttons[g].node });
                    else if ("string" === typeof g)
                        if (-1 !== g.indexOf(",")) for (n = g.split(","), p = 0, k = n.length; p < k; p++) e(n[p].trim(), l);
                        else if (g.match(/^\d+(\-\d+)*$/))
                            (p = f.map(n, function (r) {
                                return r.idx;
                            })),
                                c.push({ inst: l, node: n[f.inArray(g, p)].node });
                        else if (-1 !== g.indexOf(":name")) for (g = g.replace(":name", ""), p = 0, k = n.length; p < k; p++) n[p].name === g && c.push({ inst: l, node: n[p].node });
                        else
                            f(p)
                                .filter(g)
                                .each(function () {
    ...
    q.Api.register("buttons()", function (a, b) {
        ...
        var c = this.iterator(
            ...
            "table",
            function (d) {
                if (d._buttons) return u.buttonSelector(u.instanceSelector(a, d._buttons), b);
            },
            !0
        );
        c._groupSelector = a;
    ...
    q.Api.register("button().add()", function (a, b) {
        var c = this.context;
        c.length && ((c = u.instanceSelector(this._groupSelector, c[0]._buttons)), c.length && c[0].add(b, a));
    ...
    q.Api.register("buttons.exportInfo()", function (a) {
        ...
        return { filename: c, title: b, messageTop: L(this, a.message || a.messageTop, "top"), messageBottom: L(this, a.messageBottom, "bottom") };
    });
    var G = function (a) {
