...
function getTrackingNumber($var)
{
	if($var != '' || $var != null)
	{
		return $var;
...
function getDestinationStreetLines()
{
...
function getDestinationStateOrProvinceCode()
{
	return	'VA';
}
...
function getDestinationResidential()
{
	return	1;
}
...
function getProperty($var){
  ...
  if($var == 'shipdate') Return '2016-04-21';
	...
	if($var == 'trackingnumber') Return '999999999999';
