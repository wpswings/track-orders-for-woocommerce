...
function wps_dhl_tracking_shortcode( $atts ) {
	...
	$truck_icon_url = esc_url( $truck_icon ? $truck_icon : TRACK_ORDERS_FOR_WOOCOMMERCE_DIR_URL . 'images/truck.svg' );

	$box_icon = get_option( 'wps_dhl_truck_icon' );
	$box_icon_url = esc_url( $box_icon ? $box_icon : TRACK_ORDERS_FOR_WOOCOMMERCE_DIR_URL . 'images/box.svg' );
