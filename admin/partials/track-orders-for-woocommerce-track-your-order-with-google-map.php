...
<div class="tofwp-license-tab__hero">
	<div class="tofwp-license-tab__hero-copy">
		...
		<h2 class="tofwp-license-tab__hero-title"><?php esc_html_e( 'Track Order with Google Maps', 'track-orders-for-woocommerce' ); ?></h2>
...
<form action="" method="POST" class="wps-tofw-gen-section-form">
	<div class="tofw-secion-wrap">
		<?php
		$tofw_general_html = $wps_tofw_obj->wps_std_plug_generate_html( $tofw_track_order_gmap_settings );
