...
<div class="tofwp-license-tab__hero">
	<div class="tofwp-license-tab__hero-copy">
		...
		<h2 class="tofwp-license-tab__hero-title"><?php esc_html_e( 'Developer', 'track-orders-for-woocommerce' ); ?></h2>
	...
	<div class="wps-col-wrap">
		<div id="admin-hooks-listing" class="table-responsive mdc-data-table">
			<table class="track-orders-for-woocommerce-table mdc-data-table__table wps-table"  id="track-orders-for-woocommerce-wp">
				<thead>
				<tr><th class="mdc-data-table__header-cell"><?php esc_html_e( 'Admin Hooks', 'track-orders-for-woocommerce' ); ?></th></tr>
				<tr>
					<th class="mdc-data-table__header-cell"><?php esc_html_e( 'Type of Hook', 'track-orders-for-woocommerce' ); ?></th>
					<th class="mdc-data-table__header-cell"><?php esc_html_e( 'Hooks', 'track-orders-for-woocommerce' ); ?></th>
					<th class="mdc-data-table__header-cell"><?php esc_html_e( 'Hooks description', 'track-orders-for-woocommerce' ); ?></th>
				</tr>
				</thead>
				...
				if ( ! empty( $count_admin ) ) {
					...
					?>
					<tr class="mdc-data-table__row"><td><?php esc_html_e( 'No Hooks Found', 'track-orders-for-woocommerce' ); ?><td></tr>
					<?php
				}
				?>
				</tbody>
	...
	<div class="wps-col-wrap">
		<div id="public-hooks-listing" class="table-responsive mdc-data-table">
			<table class="track-orders-for-woocommerce-table mdc-data-table__table wps-table" id="track-orders-for-woocommerce-sys">
				<thead>
				<tr><th class="mdc-data-table__header-cell"><?php esc_html_e( 'Public Hooks', 'track-orders-for-woocommerce' ); ?></th></tr>
				<tr>
					<th class="mdc-data-table__header-cell"><?php esc_html_e( 'Type of Hook', 'track-orders-for-woocommerce' ); ?></th>
					<th class="mdc-data-table__header-cell"><?php esc_html_e( 'Hooks', 'track-orders-for-woocommerce' ); ?></th>
					<th class="mdc-data-table__header-cell"><?php esc_html_e( 'Hooks description', 'track-orders-for-woocommerce' ); ?></th>
